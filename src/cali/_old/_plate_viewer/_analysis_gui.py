...
class _CalciumAnalysisGUI(QGroupBox):
    ...
    def to_model_settings(
        ...
        gui_settings = self.value()

        # Extract nested data with defaults
        trace_data = gui_settings.trace_extraction_data
        peaks_data = gui_settings.calcium_peaks_data
        spikes_data = gui_settings.spikes_data
        exp_type_data = gui_settings.experiment_type_data
