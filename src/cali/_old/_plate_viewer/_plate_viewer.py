...
# from ._analysis_old import EVOKED, _AnalyseCalciumTraces
...
#                 cali_logger.debug(f"Loading file: {f}")
#                 yield idx + 1
...
#             cali_logger.warning(f"Failed to load plate plan from {settings_json_file}: {e}")
#             return None
...
#         except OSError as e:
#             cali_logger.error(f"Failed to save plate plan: {e}")
...
#             cali_logger.error(f"Error retrieving the plate plan: {e}")
#             return None
