...
# =======
#         if (exp := self._experiment) is None or exp.analysis_path is None:
#             cali_logger.error(
#                 "Cannot save results: No Experiment or analysis path found."
#             )
#             return

#         self._experiment = exp = save_experiment_to_database(exp)
#         cali_logger.info(
#             f"Results saved to database '{exp.analysis_path}/{exp.database_name}'."
#         )
# >>>>>>> 48b790f (wip)
