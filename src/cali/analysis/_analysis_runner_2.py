...
class AnalysisRunner:
    ...
    def _extract_trace_data_per_position(
        ...
        labels_masks = self._get_label_mask(fov_name, fov_to_analyze)
        ...
        eroded_masks, neuropil_masks_dict = self._prepare_neuropil_masks(
    ...
    def _get_label_mask(self, fov_name, fov_to_analyze):
        labels_masks = {}
