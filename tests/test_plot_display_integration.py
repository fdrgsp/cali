...
class TestPlotDisplayIntegration:
    """Test that plots actually render with real data."""

    @pytest.fixture
    def gui(self, qtbot: QtBot) -> CaliGui:
    ...
    def test_single_well_plot_displays(self, gui: CaliGui, qtbot: QtBot) -> None:
        """Test that selecting a plot type actually renders plot items."""
        widget = gui.SW_GRAPHS[0]
    ...
    def test_combo_preserves_enabled_selection_on_run_change(
        ...
        """Test combo selection persists when changing run ID.
    ...
    def test_multiple_plot_types_render(self, gui: CaliGui, qtbot: QtBot) -> None:
        """Test that multiple different plot types can be rendered."""
        widget = gui.SW_GRAPHS[0]
        ...
        # Test several different plot types
        plot_names = [
            "Calcium Raw Traces",
    ...
    def test_plot_clears_when_selecting_none(self, gui: CaliGui, qtbot: QtBot) -> None:
